...
namespace ConstruAppAPI.Models
{
    public class UserSeller
    {
        ...
        [StringLength(50, ErrorMessage = "O Nome Fantasia deve ter entre 3 e 50 caracteres", MinimumLength = 3)]
        public string FantasyName { get; set; }

        [Required(ErrorMessage = "O campo CNPJ é obrigatório.")]
        [StringLength(11, ErrorMessage = "O CNPJ deve ter 11 caracteres", MinimumLength = 11)]
